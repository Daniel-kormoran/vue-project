...
<template>
    ...
    >
      ...
      <div
        class="flip-card-front absolute left-0 top-0 flex h-full w-full items-center justify-center rounded-3xl bg-[url('https://images.unsplash.com/photo-1611689342806-0863700ce1e4?q=80&w=600')] bg-cover bg-center transition-all duration-1000 ease-in-out"
      />
      ...
      >
        ...
        <h3 class="font-semibold">National Symbol of the USA</h3>
